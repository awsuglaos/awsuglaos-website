...
import { articleService, eventService, sponsorService } from '@awsug/core';
...
export const load: PageServerLoad = async ({ setHeaders }) => {
	...
	const [upcoming, latest, sponsors, pastCount] = await Promise.all([
	...
	return { upcoming, latest, sponsors, pastCount };
};
